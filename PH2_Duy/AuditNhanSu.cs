...
namespace ATBM_PH2
{
    public partial class AuditNhanSu : Form
    {
        ...
        private void LayKq()
        {
            using (OracleConnection connection = new OracleConnection(connectionString))
            {
                try
                {
                    ...
                    connection.Open();
                    string query = "SELECT * FROM DBA_FGA_AUDIT_TRAIL WHERE policy_name ='audit_salary_selects'";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            using (OracleConnection connection = new OracleConnection(connectionString))
            {
                ...
                {
                    MessageBox.Show("Bật Audit không thành công !");
                }
            }
        }
    }
